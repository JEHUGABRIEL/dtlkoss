...
export default function PartCard({ part }) {
  ...
  return (
    <div className="flex flex-col gap-3 rounded-xl border border-line bg-paper-raised p-5">
      <div className="aspect-square overflow-hidden rounded-lg bg-vt-graphite-tint">
        <img
          src={part.image}
          alt={part.name}
      ...
      <div className="mt-auto flex items-center justify-between pt-1">
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded-full border border-vt-red px-3 py-1.5 text-sm font-medium text-vt-red transition-colors hover:bg-vt-red hover:text-white"
        >
          <PlusCircle size={15} />
          Ajouter
        </button>
